...
public class VisionListActivity extends AbstractListActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.vision_card_custom_mobilenet_click_area).setOnClickListener(v -> {
      ...
      intent.putExtra(ImageClassificationActivity.INTENT_MODULE_ASSET_NAME,
              "mobilenet_v3_custom.ptl");
      intent.putExtra(ImageClassificationActivity.INTENT_DATASET_NAME,
              Constants.DATASET_CUSTOM);
      intent.putExtra(ImageClassificationActivity.INTENT_INFO_VIEW_TYPE,
              InfoViewFactory.INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_CUSTOM_MOBILENET);
    ...
    findViewById(R.id.vision_card_resnet_click_area).setOnClickListener(v -> {
      final Intent intent = new Intent(VisionListActivity.this, ImageClassificationActivity.class);
      intent.putExtra(ImageClassificationActivity.INTENT_MODULE_ASSET_NAME, "resnet18.ptl");
      intent.putExtra(ImageClassificationActivity.INTENT_INFO_VIEW_TYPE,
